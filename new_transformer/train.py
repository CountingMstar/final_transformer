...
for k in k_list:
    ...
    def run(total_epoch, best_loss):
        ...
        for step in range(total_epoch):
            ...
            # train_type = "linear"
            # train_type = "0dot5_norm_first"
            # train_type = "0dot75_norm_first"
            ...
            f = open("result/train_loss-" + version + ".txt", "w")
            f.write(str(train_losses))
            f.close()

            f = open("result/bleu-" + version + ".txt", "w")
            f.write(str(bleus))
            f.close()

            f = open("result/test_loss-" + version + ".txt", "w")
